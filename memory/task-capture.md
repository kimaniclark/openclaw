# Task Capture - Someday/Maybe List

## Purpose
Items that aren't ready for Motion but worth keeping for future consideration. Not urgent, not scheduled, but potentially valuable.
...
- [ ] Try the Polar AI browser (polarbrowser.com) — browser-native agent for automation (added Aug 7, bumped Aug 15)
- [ ] Sign up for SQL course/platform (added Aug 7)
- [ ] Get a dentist recommendation from Dr. Oshalim (added Aug 11)
- [ ] Talk to Chris Gowan about the litigation funding loan (added Aug 12)
- [ ] Get white Under Armour slides (added Aug 12)
- [ ] Enroll Stacy Holland (Holland Debt Solutions) in the Modern Owner course (added Aug 13)
- [ ] Call Shellpoint (added Aug 13)
- [ ] Call Atlantic Union Bank (added Aug 13)
- [ ] Call the notary company (added Aug 13)
- [ ] Finish Allison's application (added Aug 13)
- [ ] Do the Final Office Action (added Aug 13)
- [ ] Pay Black Hills (added Aug 13)
- [ ] Register tastemakers.co domain (added Aug 13)
- [ ] Arrange an after party bouncer (added Aug 15)
...
**Review Schedule:** Monthly (review during weekly processing)
**Archive Rule:** Move stale items (6+ months, no longer relevant) to archive section below

## Archive
*(Moved from active consideration)*
